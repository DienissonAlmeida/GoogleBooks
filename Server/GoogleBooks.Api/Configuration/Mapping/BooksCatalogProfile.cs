...
namespace GoogleBooks.Api.Configuration.Mapping
{
    public class BooksCatalogProfile : Profile
    {
        ...
        {
            CreateMap<Client.Dtos.Output.ReadingModes, Domain.Dtos.Output.ReadingModes>();
            ...
            CreateMap<GoogleBookDetailsLite, BookDetailsForCatalog>()
                ...
                .ForMember(dest => dest.IndustryIdentifiers, opt => opt.MapFrom(src => src.VolumeInfo.IndustryIdentifiers));
        }
    }
}
